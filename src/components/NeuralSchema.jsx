...
const NeuralSchema = ({ isLooking = false, emotion = 'neutral' }) => {
  ...
  return (
    <div 
      className="relative flex items-center justify-center w-full h-full min-h-[320px] md:min-h-[500px] perspective-[1000px] overflow-visible"
      onMouseMove={handleMouseMove}
      onMouseLeave={() => { mouseX.set(0); mouseY.set(0); }}
    >
      <div className="scale-[0.55] sm:scale-[0.75] md:scale-95 lg:scale-100 origin-center transition-transform flex items-center justify-center">
        <Motion.div 
